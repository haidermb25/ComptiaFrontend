...
export default function ExploreTechCareers() {
  const tabs = ["All", "Digital Foundations", "AI", "Cloud", "Cyber","Data","Network","Tech Support"];
    ...
    <div className="w-full bg-gray-50 relative">
      ...
      <div className="bg-white py-16 px-4 text-center">
        <h1 className="text-5xl font-bold text-gray-900 mb-1">
          Explore <span style={{ color: '#951A6B' }}>Tech Careers</span>
        </h1>
