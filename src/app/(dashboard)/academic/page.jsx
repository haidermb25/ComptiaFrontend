  ...
  return (
    <div className="w-full bg-gray-50 relative" style={{
      ...
      <div className="bg-white py-16 px-8 text-center">
        ...
        <span style={{ color: '#951A6B' }}>Academic</span>
        </h1>
        <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
CompTIA bridges the gap between education and industry, offering clear career pathways, hands-on learning, and the support needed to succeed in a rapidly evolving tech landscape. Explore how CompTIA can help you, your students, or your institution thrive in the world of tech.
        </p>
      </div>
